...
% 4. Compute the entropy for each one of the predictors in the previous exercise. Which predictor will compress better?



img = imread('lena.png');

% 1. Divide to 8x8 blocks.
% 2. Compute the DCT of each block.
% 3. Quantize each block.Try different N.
% 4. 
